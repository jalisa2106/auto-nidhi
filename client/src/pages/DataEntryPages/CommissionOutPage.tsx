...
export default function CommissionOutPage() {
  ...
  const loadCommissions = useCallback(async () => {
    setLoading(true)
    try {
      const res = await commissionsOutApi.list({
        page,
        limit: pageSize,
        search: debouncedSearch || undefined,
        payee_type: filterType || undefined,
  ...
  const exportPDF = (itemsToExport?: any[]) => {
    ...
    doc.setFontSize(16)
    doc.text('Commission OUT Report (Page)', 14, 15)
    doc.setFontSize(10)
      ...
      <div className="pay-kpi-row">
        <div className="pay-kpi-card">
          ...
          <div className="pay-kpi-body">
            <div className="pay-kpi-label">Paid (Current Page)</div>
