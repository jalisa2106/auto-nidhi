...
export default function CommissionInPage() {
  ...
  // KPI Metrics Computing (on current page rows for visual summary)
  ...
  useEffect(() => {
    setPage(1)
  }, [debouncedSearch, filterType, filterMode, filterDateFrom, filterDateTo])
  ...
  const exportPDF = (itemsToExport?: any[]) => {
    ...
    doc.setFontSize(16)
    doc.text('Commission IN Report (Page)', 14, 15)
    doc.setFontSize(10)
  ...
  return (
    <>
      ...
      <div className="pay-kpi-row">
        <div className="pay-kpi-card">
          ...
          <div className="pay-kpi-body">
            <div className="pay-kpi-label">Received (Current Page)</div>
            <div className="pay-kpi-value" style={{ color: '#137333' }}>{fmtINR(kpiTotal)}</div>
            <div className="pay-kpi-sub">{rows.length} transactions shown</div>
          </div>
        </div>
        <div className="pay-kpi-card">
      ...
      {/* Structured Ledger Layout Data Grid */}
      <div className="data-card">
        {loading ? (
          <div className="data-empty">Loading commissions...</div>
        ) : rows.length === 0 ? (
                    ...
                    <tr key={r.id}>
                      ...
                      <td>
                        <span
                          ...
                          onClick={() => r.file_id && setDrawerFileId(r.file_id)}
                ...
                <div className="pay-detail-item">
                  ...
                  <div className="pay-detail-val">
                    <span
                      ...
                      onClick={() => {
                        if (viewRow.file_id) {
                          setDrawerFileId(viewRow.file_id);
                          setViewRow(null);
                        }
                      }}
                    >
